...
const page = () => {
  ...
  return (
    <div>
      <header className="bg-white rounded-b-lg overflow-hidden">
        <div className="pt-16 pb-[2px] rounded-b-lg overflow-hidden">
      ...
      <main className="bg-[#E0E1E7] min-h-screen pt-4">
