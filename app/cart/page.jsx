...
import { clearCart, selectCartItems, selectSelectedAddress, selectTotalWithoutDiscount, updateItemQuantity } from "../store/cartSlice";
  ...
  const handleCheckout = async () => {
    ...
    try {
      await addDoc(collection(DB, "orders"), {
        items: cartItems,
        cookingReqText: cookingReq ? cookingReqText : null,
        confessionText: isConfession ? confessionText : null,
