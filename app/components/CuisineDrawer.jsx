  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`rounded-t-lg bottom-0 fixed ${!cuisine?.isAvailable ? "grayscale" : ""} overflow-hidden z-[99999] self-end h-full w-full flex flex-col flex-1 bg-[#F6F6F6] overflow-y-scroll no-scrollbar  transition-all  ${openDrawer ? " translate-y-0" : " translate-y-full"
          }`}
      >
