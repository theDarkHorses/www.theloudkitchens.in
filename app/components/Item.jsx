    ...
    <section className="flex justify-between py-7 px-5">
      <div className="w-2/3">
        <Image
          ...
          alt="type"
        />
        <h3 className="font-raleway text-lg font-semibold ">{item.name}</h3>
        ...
        <p className="text-xs font-lato font-semibold text-[#555555] mt-5 mb-2">
          🔥 +934 Kcal{" "}
        </p>
        <ToggleString
          string="
      ...
      <div className="flex flex-col items-center w-1/3">
        ...
        />
        <Link
          href={`?tab=${activeTab}&item=${item.name}`}
          className="text-primary py-1 px-8 border-[1px] border-primary font-raleway text-lg font-semibold bg-[#FFE7E7] text-center rounded-lg -m-4 relative  shadow-lg shadow-red-200"
        >
          ADD
        </Link>
      </div>
